...
<body>
	...
	<br>
	<p>To create employee, select Employee List of that particular Manager</p>
	<p>
		...
		<c:forEach var="list" items="${mList}">
			<tr>
				...
				<td><a href='updateMng?UpdateId=${list.id}&PositionId=${list.managerPos}&DepartmentId=${list.managerDept}'>Edit</a></td> 
 				...
 				<td><a href='http://localhost:8088/employee/findAllEmployee?ManagerId=${list.id}'>Employee List</a></td>
			</tr>
		</c:forEach>
	</table>
	</form>                                                      
